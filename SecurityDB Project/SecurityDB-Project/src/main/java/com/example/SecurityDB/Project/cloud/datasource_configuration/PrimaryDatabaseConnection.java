package com.example.SecurityDB.Project.cloud.datasource_configuration;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.SecurityDB.Project.cloud.repository"}
)
public class PrimaryDatabaseConnection {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.example.SecurityDB.Project.cloud.model")
                .properties(props)
                .build();
    }
